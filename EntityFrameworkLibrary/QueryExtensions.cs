...
public static class QueryExtensions
{
    ...
    {
        /*
         * CONSOLE_ENVIRONMENT is an environment variable that can be set to
         * "Development" to enable debug tagging of queries.
         *
         * Change to an environment variable that exists in your environment.
         */
        if (Environment.GetEnvironmentVariable("CONSOLE_ENVIRONMENT") == "Development")
        {
