...
internal class SetupLogging
{
    ...
    public static void Development()
    {
        const string outputTemplate = 
            ...
            "{NewLine}in method {MemberName} at {FilePath}:{LineNumber}{NewLine}{Exception}{NewLine}";
        /*
         * For demonstration purposes, the log files are stored in a directory named "LogFiles" in
         * the application's base directory. Out in production the location would be on a server.
         */
