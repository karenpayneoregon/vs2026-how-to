...
public class MockedData
{
    ...
    [
        ...
        new() { WineId = 7, Name = "Cabernet Sauvignon", WineType = WineType.Red },
        new() { WineId = 8, Name = "Chardonnay Reserve", WineType = WineType.White },
        new() { WineId = 9, Name = "Merlot Classic", WineType = WineType.Red },
        new() { WineId = 10, Name = "Blush Zinfandel", WineType = WineType.Rose }
    ];
}